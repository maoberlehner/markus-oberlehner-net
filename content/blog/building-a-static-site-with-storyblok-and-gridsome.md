...
For this article, I'll assume that you have some basic knowledge about how to build websites wit Storyblok. If you're completely new to Storyblok, you can [read my previous article about building sites with Storyblok and Nuxt.js](https://markus.oberlehner.net/blog/building-a-pre-rendered-website-with-nuxt-and-storyblok/) where I take a deeper look at how to build pages with Storyblok.
