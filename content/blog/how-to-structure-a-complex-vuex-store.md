...
description = "Learn how to structure a complex Vuex store, how to enable lazy loading of Vuex modules and how to use models to send data from the Vuex store to an API."
